...
$aTabs = array();
$aTabs[] = array("DIV" => "edit1", "TAB" => "Новость", "ICON"=>"iblock_element", "TITLE"=> "Новость");
//$aTabs[] = array("DIV" => "edit5", "TAB" => GetMessage("IBEL_E_TAB_PREV"), "ICON"=>"iblock_element", "TITLE"=>GetMessage("IBEL_E_TAB_PREV_TITLE"));
//$aTabs[] = array("DIV" => "edit6", "TAB" => "Текст новости", "ICON"=>"iblock_element", "TITLE"=>"Текст новости");
...
?>
        ...
        <tr>
                <td width="20%"><span class="required">*</span>Заголовок новости</td>
                <td width="80%">
...
?><?/*
        ...
        <?if(COption::GetOptionString("iblock", "use_htmledit", "Y")=="Y" && CModule::IncludeModule("fileman")):?>
        <tr>
                <td><br/>Текст новости</td><td></td>
        </tr>
        <tr>
                <td colspan="2" align="center">
                        <?CFileMan::AddHTMLEditorFrame("DETAIL_TEXT", $str_DETAIL_TEXT, "DETAIL_TEXT_TYPE", $str_DETAIL_TEXT_TYPE, 180, "N", 0, "", "", $arIBlock["LID"]);?>
                </td>
        </tr>
        <?else:?>
        <tr>
        ...
        <tr>
                <td>Дата (<?echo CLang::GetDateFormat("SHORT");?>)</td>
                <td><?echo CalendarDate("ACTIVE_FROM", $str_ACTIVE_FROM, "form_element", "19")?></td>
        </tr>
