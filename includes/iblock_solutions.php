...
$aTabs = array();
$aTabs[] = array("DIV" => "edit1", "TAB" => "Решение", "ICON"=>"iblock_element", "TITLE"=> "Решение");
$aTabs[] = array("DIV" => "edit5", "TAB" => "Для чего в целом предназначена программа ", "ICON"=>"iblock_element", "TITLE"=>"Для чего в целом предназначена программа <!--span class='required'>*</span-->");
$aTabs[] = array("DIV" => "edit6", "TAB" => "Описание функционала", "ICON"=>"iblock_element", "TITLE"=>"Описание функционала <!--span class='required'>*</span-->");
...
?>
        ...
        <tr>
                <td><span class="required">*</span>Наименование программного продукта</td>
                <td>
        ...
        <?if(count($PROP)>0):?>
                ...
                foreach($PROP as $prop_code=>$prop_fields):
                        ...
                        if ($prop_code=="PLATFORM") $prop_fields["NAME"]="Платформа, используемые компоненты/типовые конфигурации";
                ?>
                <tr>
